...
public class nopcommerceStep {
    ...
    public void enter_registered_username_and_password() throws Throwable {
        driver.findElement(By.id("username")).sendKeys("lightyear9461@gmail.com");
        driver.findElement(By.id("password")).sendKeys("Avadh@20090");
    }
